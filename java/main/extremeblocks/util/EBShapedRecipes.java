...
public class EBShapedRecipes implements IRecipe
{
	...
	{
		for (int i = 0; i <= BlockEBTable.CRAFTING_SLOTS - this.recipeWidth; ++i)
		{
			for (int j = 0; j <= BlockEBTable.CRAFTING_SLOTS - this.recipeHeight; ++j)
			{
	...
	public EBShapedRecipes func_92100_c()
	{
