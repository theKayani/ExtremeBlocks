package main.extremeblocks.builder;
...
public class Constructor
{
	...
	public Constructor(World worldObj, int baseX, int baseY, int baseZ)
	{
	...
	private void buildSteakHouse(int stage)
	{
		switch (stage)
		{
			case 0:
			{
				for (int i = 6; i >= 0; i--)
				{
					WorldUtil.createLayer(worldObj, baseX, baseY + i, baseZ, Blocks.air, 12, 16);
				}
				break;
			}
			case 1:
			{
				for (int i = 5; i >= 0; i--)
				{
					WorldUtil.createLayer(worldObj, baseX, baseY + i, baseZ, Blocks.planks, 12, 16);
					WorldUtil.createLayer(worldObj, baseX, baseY + i, baseZ, Blocks.air, 10, 14);
				}
				WorldUtil.createLayer(worldObj, baseX, baseY + 5, baseZ, Blocks.planks, 12, 16);
				WorldUtil.createLayer(worldObj, baseX, baseY, baseZ, Blocks.planks, 12, 16);
				break;
			}
			case 2:
			{
				WorldUtil.createLayer(worldObj, baseX - 1, baseY + 1, baseZ - 5, Blocks.planks, 10, 0);
			...
			case 9:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY + 2, baseZ + 8, Blocks.glass_pane, 10, 0);
				WorldUtil.createLayer(worldObj, baseX, baseY + 3, baseZ + 8, Blocks.glass_pane, 10, 0);
				break;
			}
			case 10:
			{
				WorldUtil.createLayer(worldObj, baseX + 6, baseY + 2, baseZ, Blocks.glass_pane, 0, 10);
				WorldUtil.createLayer(worldObj, baseX + 6, baseY + 3, baseZ, Blocks.glass_pane, 0, 10);
				break;
			}
			case 11:
			{
			...
			case 18:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY + 4, baseZ, Blocks.planks, 0, 14);
				WorldUtil.createLayer(worldObj, baseX + 1, baseY + 4, baseZ, Blocks.torch, 0, 14);
				WorldUtil.createLayer(worldObj, baseX - 1, baseY + 4, baseZ, Blocks.torch, 0, 14);
				WorldUtil.createLayer(worldObj, baseX + 5, baseY + 4, baseZ, Blocks.torch, 0, 14);
				WorldUtil.createLayer(worldObj, baseX - 5, baseY + 4, baseZ, Blocks.torch, 0, 14);
				break;
			}
			case 19:
	...
	public void buildHouse(int stage)
	{
		switch (stage)
		{
			case 0:
			{
				for (int i = 7; i >= 0; i--)
				{
					WorldUtil.createLayer(worldObj, baseX, baseY + i, baseZ, Blocks.air, 6, 8);
				}
				break;
			}
			case 1:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY, baseZ, Blocks.brick_block, 6, 8);
				break;
			}
			case 2:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY + 1, baseZ, Blocks.brick_block, 6, 8);
				WorldUtil.createLayer(worldObj, baseX, baseY + 1, baseZ, Blocks.air, 4, 6);
				break;
			}
			case 3:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY + 2, baseZ, Blocks.brick_block, 6, 8);
				WorldUtil.createLayer(worldObj, baseX, baseY + 2, baseZ, Blocks.air, 4, 6);
				break;
			}
			case 4:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY + 3, baseZ, Blocks.brick_block, 6, 8);
				break;
			}
			case 5:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY + 4, baseZ, Blocks.brick_block, 6, 8);
				WorldUtil.createLayer(worldObj, baseX, baseY + 4, baseZ, Blocks.air, 4, 6);
				break;
			}
			case 6:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY + 5, baseZ, Blocks.brick_block, 6, 8);
				WorldUtil.createLayer(worldObj, baseX, baseY + 5, baseZ, Blocks.air, 4, 6);
				break;
			}
			case 7:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY + 6, baseZ, Blocks.brick_block, 6, 8);
				break;
			}
			case 8:
			{
	...
	private void buildDirtHut(int stage)
	{
		switch (stage)
		{
			case 0:
			{
				WorldUtil.fillWithBlocks(worldObj, baseX, baseY + 3, baseZ, Blocks.dirt, 4);
				WorldUtil.fillWithBlocks(worldObj, baseX, baseY + 3, baseZ, Blocks.air, 3);
				break;
			}
			case 1:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY + 6, baseZ, Blocks.torch, 5, 5);
				break;
			}
			case 2:
			{
	...
	private void buildSmallBakery(int stage)
	{
		switch (stage)
		{
			case 0:
			{
				for (int i = 7; i >= 0; i--)
				{
					WorldUtil.createLayer(worldObj, baseX, baseY + i, baseZ, Blocks.air, 8, 12);
				}
				break;
			}
			case 1:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY, baseZ, Blocks.cobblestone, 8, 12);
				break;
			}
			case 2:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY + 1, baseZ, Blocks.planks, 8, 12);
				WorldUtil.createLayer(worldObj, baseX, baseY + 1, baseZ, Blocks.air, 6, 10);
				break;
			}
			case 3:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY + 2, baseZ, Blocks.planks, 8, 12);
				WorldUtil.createLayer(worldObj, baseX, baseY + 2, baseZ, Blocks.air, 6, 10);
				break;
			}
			case 4:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY + 3, baseZ, Blocks.planks, 8, 12);
				WorldUtil.createLayer(worldObj, baseX, baseY + 3, baseZ, Blocks.air, 6, 10);
				break;
			}
			case 5:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY + 4, baseZ, Blocks.planks, 6, 10);
				WorldUtil.createLayer(worldObj, baseX, baseY + 4, baseZ, Blocks.air, 4, 8);
				break;
			}
			case 6:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY + 5, baseZ, Blocks.planks, 4, 8);
				WorldUtil.createLayer(worldObj, baseX, baseY + 5, baseZ, Blocks.air, 2, 6);
				break;
			}
			case 7:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY + 6, baseZ, Blocks.planks, 2, 6);
				WorldUtil.createLayer(worldObj, baseX, baseY + 6, baseZ, Blocks.air, 0, 4);
				break;
			}
			case 8:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY + 7, baseZ, Blocks.wooden_slab, 0, 4);
				break;
			}
			case 9:
			{
			...
			case 11:
			{
				...
				createTable(-2, 1, 4);
				WorldUtil.createLayer(worldObj, baseX, baseY + 1, baseZ, Blocks.log, 0, 4);
				break;
			}
			case 12:
			{
	...
	private void buildFarm(int stage)
	{
		switch (stage)
		{
			case 0:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY - 1, baseZ, Blocks.grass, 6, 4);
				break;
			}
			case 1:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY, baseZ, Blocks.log, 6, 4);
				WorldUtil.createLayer(worldObj, baseX, baseY, baseZ, Blocks.air, 4, 2);
				break;
			}
			case 2:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY, baseZ, Blocks.farmland, 4, 2);
				WorldUtil.createLayer(worldObj, baseX, baseY, baseZ, Blocks.air, 1, 0);
				break;
			}
			case 3:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY, baseZ, Blocks.flowing_water, 1, 0);
				break;
			}
			case 4:
			{
				WorldUtil.createLayer(worldObj, baseX, baseY + 1, baseZ, Blocks.wheat, 4, 2);
				break;
			}
			case 5:
			{
