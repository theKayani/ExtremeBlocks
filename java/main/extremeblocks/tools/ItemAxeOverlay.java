...
public class ItemAxeOverlay extends ItemAxe
{
	...
	public ItemAxeOverlay(ToolMaterial mat, int color)
	{
		super(mat);
		headColor = color;
		name = mat.name().substring(0, 1).toUpperCase() + mat.name().substring(1).toLowerCase() + " Axe";
	...
	{
		stick = ir.registerIcon(Init.MODID + ":stick_axe");
		head = ir.registerIcon(Init.MODID + ":head_axe");
	}
}
