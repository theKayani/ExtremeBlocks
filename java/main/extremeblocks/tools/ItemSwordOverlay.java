...
public class ItemSwordOverlay extends ItemSword
{
	...
	public ItemSwordOverlay(ToolMaterial mat, int color)
	{
		super(mat);
		headColor = color;
		name = mat.name().substring(0, 1).toUpperCase() + mat.name().substring(1).toLowerCase() + " Sword";
	...
	{
		stick = ir.registerIcon(Init.MODID + ":stick_sword");
		head = ir.registerIcon(Init.MODID + ":head_sword");
	}
}
