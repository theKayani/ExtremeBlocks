...
public interface GuiIDs
{
	...
	public static final int BLOCK_EBTABLE = 4;
	public static final int GUI_ROBOT = 5;
	public static final int GUI_ROBOT_INV = 6;
	public static final int GUI_ROBOT_COMMANDS = 7;
