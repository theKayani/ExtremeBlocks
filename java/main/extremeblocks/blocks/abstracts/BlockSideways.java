...
public class BlockSideways extends BlockRotatedPillar implements IInfo, IInitialization
{
	private boolean showRecipe;
	private IIcon topIcon;

	public BlockSideways(Material mat, String blockName, String textureName)
	{
		super(mat);
	...
	public BlockSideways showRecipe()
	{
		showRecipe = true;
		return this;
	}
