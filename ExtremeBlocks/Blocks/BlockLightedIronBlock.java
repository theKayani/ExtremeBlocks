...
public class BlockLightedIronBlock extends Block {
	public BlockLightedIronBlock(int par1, Material par2Material) {
		super(par1, par2Material);
		this.setUnlocalizedName("LightedIronBlock");
	...
	public boolean onBlockActivated(World par1World, int par2, int par3,
		...
		par1World.setBlock(par2, par3, par4,
				ExtremeBlocksMain.OffIronBlock.blockID);
		return true;
	}
}
