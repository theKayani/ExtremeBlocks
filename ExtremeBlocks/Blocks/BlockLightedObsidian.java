...
public class BlockLightedObsidian extends Block 
{
	public BlockLightedObsidian(int par1, Material par2Material) 
	{
		super(par1, par2Material);
		this.setUnlocalizedName("LightedObsidian");
	...
	public boolean onBlockActivated(World par1World, int par2, int par3,int par4, EntityPlayer par5EntityPlayer, int par6, float par7,float par8, float par9) 
	{
		...
		par1World.setBlock(par2, par3, par4, ExtremeBlocksMain.OffObsidian.blockID);
		return true;
	}
}
