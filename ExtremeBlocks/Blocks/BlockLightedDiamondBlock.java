...
public class BlockLightedDiamondBlock extends Block {
	public BlockLightedDiamondBlock(int par1, Material par2Material) {
		super(par1, par2Material);
		this.setUnlocalizedName("LightedDiamondBlock");
	...
	public boolean onBlockActivated(World par1World, int par2, int par3,
		...
		par1World.setBlock(par2, par3, par4,
				ExtremeBlocksMain.OffDiamondBlock.blockID);
		return true;
	}
}
