...
public class BlockOffGlass extends Block
{
	...
	{
		this.blockIcon = par1IconRegister.registerIcon(ExtremeBlocksMain.modid + ":" + "LightedGlass");
	}

	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9) 
	{
		breakBlock(par1World, par2, par3, par4, par3, par2);
		par1World.setBlock(par2, par3, par4, ExtremeBlocksMain.LightedGlass.blockID);
		return true;
	}
