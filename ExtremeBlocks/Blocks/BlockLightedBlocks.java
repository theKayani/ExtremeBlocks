...
public class BlockLightedBlocks extends Block 
{
	public String name;
	...
	public BlockLightedBlocks(int par1, Material par2Material, String par3String, Block par4Block, StepSound par5StemSound) 
	{
		...
		this.setUnlocalizedName("Lighted" + name);
