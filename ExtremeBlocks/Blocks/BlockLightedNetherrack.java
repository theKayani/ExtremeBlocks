...
public class BlockLightedNetherrack extends Block 
{
	public BlockLightedNetherrack(int par1, Material par2Material) 
	{
		super(par1, par2Material);
		this.setUnlocalizedName("LightedNetherrack");
	...
	public boolean onBlockActivated(World par1World, int par2, int par3,int par4, EntityPlayer par5EntityPlayer, int par6, float par7,float par8, float par9) 
	{
		...
		par1World.setBlock(par2, par3, par4, ExtremeBlocksMain.OffNetherrack.blockID);
		return true;
	}
}
