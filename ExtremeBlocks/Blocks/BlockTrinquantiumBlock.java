...
public class BlockTrinquantiumBlock extends Block 
{
	public BlockTrinquantiumBlock(int par1, Material par2Material) 
	{
		super(par1, par2Material);
		this.setHardness(5.0F);
		this.setUnlocalizedName("TrinquantiumBlock");
