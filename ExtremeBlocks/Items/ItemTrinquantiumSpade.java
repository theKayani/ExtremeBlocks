...
public class ItemTrinquantiumSpade extends ItemSpade
{
	public ItemTrinquantiumSpade(int par1, EnumToolMaterial par2) 
	{
		super(par1, par2);
		this.setCreativeTab(ExtremeBlocksMain.EBToolsTab);
		this.setUnlocalizedName("TrinquantiumSpade");
	}
